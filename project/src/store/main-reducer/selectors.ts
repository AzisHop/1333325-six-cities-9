...
export const getOrderedPlaces1 = (state: State, sortBy: Options, filterBy: string): Hotel[] => {
  const places = state[Reducers.MAIN].places
...
export const getOrderedPlaces = createSelector(getSortOption, getCity, getPlaces, (sortBy, filterBy, placesMain) => {
